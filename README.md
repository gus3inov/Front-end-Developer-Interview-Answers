...
###### :heavy_check_mark: A: 
`this` - это привязка контекста к функции, которая создается во время вызоыва функции, и на что она ссылается определяется тем, где и при каких условиях функция была вызвана. При каждом вызове функции создается новый `this`
